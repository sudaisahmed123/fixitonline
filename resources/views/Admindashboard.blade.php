        ...
        <div class="deznav">
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a href="task.html" class="" aria-expanded="false">
                            <div class="menu-icon">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li>
                        <a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                            ...
                            <span class="nav-text">CMS</span><span class="badge badge-xs style-1 badge-danger">New</span>
                        </a>
                        <ul aria-expanded="false">
                            ...
                            <div class="col-xl-12">
                                <div class="row">
                                    ...
                                    <div class="col-xl-3 col-sm-6">
                                        <div class="card bg-success rainbow-box" style="background-image: url(images/rainbow.gif);background-size: cover;background-blend-mode: luminosity;">
                                            <div class="card-header border-0">
