...
<head>
    ...
    <title>Helperman Multipurpose HTML Template | Homepage</title>
                ...
                <div class="auto-container">
                    <div class="clearfix">
                        ...
                        <div class="pull-right upper-right clearfix">
                            ...
                            <!--Info Box-->
                            <div class="upper-column info-box">
                                <a href="about.html" class="theme-btn btn-style-one"><span class="txt">Request Quote</span></a>
                            </div>
                        ...
                        <nav class="main-menu navbar-expand-md">
                            ...
                            <div class="navbar-collapse collapse clearfix" id="navbarSupportedContent">
                                <ul class="navigation clearfix">
                                    <li class=" current"><a href="/plumberhome">Home</a>
                                        {{-- <ul>
                                            <li><a href="index.html">Handyman Demo</a></li>
                                            <li><a href="helperman-single-2.html">Construction Demo</a></li>
                                            <li><a href="index-3.html">Industry Demo</a></li>
                                            <li><a href="index-4.html">Interior Demo</a></li>
                                            <li class="dropdown"><a href="#">Single Pages</a>
                                                <ul>
                                                    <li><a href="helperman-single.html">Handyman One Page</a></li>
                                                    <li><a href="helperman-single-2.html">Construction One Page</a></li>
                                                    <li><a href="helperman-single-3.html">Industry One Page</a></li>
                                                    <li><a href="helperman-single-4.html">Interior One Page</a></li>
                                                </ul>
                                            </li>
                                        </ul> --}}
                                    </li>
                                    <li class=""><a href="/plumabout">About us</a>
                                        {{-- <ul>
                                    ...
                                    <li class="dropdown"><a href="#">Services</a>
                                        <ul>
                                            <li><a href="/plumberhome">Plumber</a></li>
                                            <li><a href="/electricianhome">Electrician</a></li>
                                            <li><a href="/acrepair">Ac Reparing</a></li>
                                            <li><a href="/carmecha">Car Mechanic</a></li>
                                            <li><a href="/carpaint">Car Painter</a></li>
                                            <li><a href="/homedeco">Home Decorator</a></li>
                                            <li><a href="/labours">Labours</a></li>
                                        </ul>
                                    </li>
                                    <li class="dropdown"><a href="/plumprojects">Projects</a>
                                        {{-- <ul>
                                            <li><a href="projects.html">Projects</a></li>
                                            <li><a href="projects-single.html">Projects Single</a></li>
                                        </ul> --}}
                                    </li>
                                    <li class="current"><a href="/plumblog">Blog</a>
                                        {{-- <ul>
                                    ...
                                    <li><a href="/plumcontactus">Contact us</a></li>
                                </ul>
                            </div>
                        </nav>
                        <!-- Main Menu End-->
                            ...
                            <div class="navbar-collapse collapse clearfix" id="navbarSupportedContent1">
                                <ul class="navigation clearfix">
                                    <li class=" current"><a href="/plumberhome">Home</a>
                                        {{-- <ul>
                                            <li><a href="index.html">Handyman Demo</a></li>
                                            <li><a href="index-2.html">Construction Demo</a></li>
                                            <li><a href="index-3.html">Industry Demo</a></li>
                                            <li><a href="index-4.html">Interior Demo</a></li>
                                            <li class="dropdown"><a href="#">Single Pages</a>
                                                <ul>
                                    ...
                                    <li class="current"><a href="/plumabout">About us</a>
                                        {{-- <ul>
                                    ...
                                    <li class="current"><a href="/plumprojects">Projects</a>
                                        {{-- <ul>
                                            <li><a href="projects.html">Projects</a></li>
                                            <li><a href="projects-single.html">Projects Single</a></li>
                                        </ul> --}}
                                    ...
                                    <li class="dropdown"><a href="/plumblog">Blog</a>
                                        {{-- <ul>
                                            <li><a href="blog.html">Our Blog</a></li>
                                            <li><a href="blog-detail.html">Blog Details</a></li>
                                        </ul> --}}
