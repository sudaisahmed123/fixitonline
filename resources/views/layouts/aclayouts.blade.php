                        ...
                        <nav class="main-menu navbar-expand-md">
                            ...
                            <div class="navbar-collapse collapse clearfix" id="navbarSupportedContent">
                                <ul class="navigation clearfix">
                                    <li class=" current"><a href="/acrepair">Home</a>
                                        {{-- <ul>
                                    ...
                                    <li class=""><a href="/acabout">About us</a>
                                        {{-- <ul>
                                    ...
                                    <li class="dropdown"><a href="/acprojects">Projects</a>
                                        {{-- <ul>
                                            <li><a href="projects.html">Projects</a></li>
                                            <li><a href="projects-single.html">Projects Single</a></li>
                                        </ul> --}}
                                    </li>
                                    <li class="current"><a href="/acblog">Blog</a>
                                        {{-- <ul>
                                    ...
                                    <li><a href="/accontactus">Contact us</a></li>
                                </ul>
                            </div>
                        </nav>
                        <!-- Main Menu End-->
                        ...
                        <nav class="main-menu  navbar-expand-md">
                            ...
                            <div class="navbar-collapse collapse clearfix" id="navbarSupportedContent1">
                                <ul class="navigation clearfix">
                                    ...
                                    <li class="current"><a href="/acabout">About us</a>
                                        {{-- <ul>
                                    ...
                                    <li class="current"><a href="/acprojects">Projects</a>
                                        {{-- <ul>
                                            <li><a href="projects.html">Projects</a></li>
                                            <li><a href="projects-single.html">Projects Single</a></li>
                                        </ul> --}}
                                    ...
                                    <li class="dropdown"><a href="/acblog">Blog</a>
                                        {{-- <ul>
                                            <li><a href="blog.html">Our Blog</a></li>
                                            <li><a href="blog-detail.html">Blog Details</a></li>
                                        </ul> --}}
