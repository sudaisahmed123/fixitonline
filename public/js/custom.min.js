var YashAdmin = function() {
    ...
    $(window).height();
    var t = function() {
            jQuery(".default-select,.table-responsive select").length > 0 && (jQuery(".default-select").selectpicker(), jQuery(".default-select,.table-responsive select").selectpicker())
        },
        n = function() {
            setTimeout(function() {
        ...
        o = function() {
            let e = new Date,
                t = e.getFullYear(),
                n = document.getElementsByClassName("current-year");
            for (let a of n) a.innerHTML = t
        },
        l = function() {
        ...
        d = function() {
            ...
            (e > 0 ? e : screen.height) && ($(".content-body").css("min-height", window.innerHeight - 60 + "px"), "mini" === $("body").attr("data-sidebar-style") && $(".deznav .metismenu").height() > window.innerHeight - 60 && $(".content-body").css("min-height", $(".deznav .metismenu").height() + 60 + "px"))
        },
        u = function() {
        ...
        _ = function() {
            e > 1024 && $(".metismenu  li").unbind().each(function(e) {
                if ($("ul", this).length > 0) {
                    ...
                    $("body").height();
                    var i = $("body").width();
                    if (jQuery("html").hasClass("rtl")) var s = n + a <= i;
                    else var s = n > 0;
        ...
        S = function(e) {
            parseInt($(".header").css("height"), 10), $(".navbar-nav .scroll").on("click", function(e) {
                if (e.preventDefault(), jQuery(".navbar-nav .scroll").parent().removeClass("active"), jQuery(this).parent().addClass("active"), "" !== this.hash) {
                    var t = parseInt($(this.hash).offset().top, 10),
                        n = parseInt($(".header .header-content").css("height"), 10);
                    $("html, body").animate({
                        scrollTop: t - n
                    }, 800, function() {})
                }
            ...
            if (jQuery(".navbar-nav").length > 0) {
                ...
                jQuery(document).on("scroll", function() {
                    ...
                    jQuery(".navbar-nav .scroll").each(function() {
                        var n, a = jQuery(this);
                        jQuery(a.attr("href")), parseInt(jQuery(this.hash).offset().top, 10) - t <= e && (jQuery(".navbar-nav .scroll").parent().removeClass("active"), a.parent().addClass("active"))
                    })
                })
            }
        },
    ...
    return {
        init: function() {
            i(), s(), l(), c(), r(), d(), u(), h(), f(), v(), p(), g(), b(), k(), C(), y(), x(), z(), w(), F(), m(), E(), A(), q(), t(), S(), o(), _(), H(), a()
        },
        load: function() {
            n()
        },
...
jQuery(document).ready(function() {
    ...
    "use strict";
    YashAdmin.load(), setTimeout(function() {
        YashAdmin.handleMenuPosition()
    }, 1e3)
}), jQuery(window).on("resize", function() {
    "use strict";
    YashAdmin.resize(), setTimeout(function() {
        YashAdmin.handleMenuPosition()
    }, 1e3)
});